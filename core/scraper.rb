#!/usr/bin/env ruby
# Scraper utility tool for data gathering
...
# Downloads multiple files into the target_dir according to the file_names
# Current link is used in the case of relative URIs to create the full path
def download_files_from_URLs(agent, target_dir, links, file_in_names, current_link)
...
# Downloads single file from a URL
